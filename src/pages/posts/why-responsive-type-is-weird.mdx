...
The most recent fluid typography technique uses a <a href="https://www.smashingmagazine.com/2022/01/modern-fluid-typography-css-clamp/">very clever formula</a> to calculate the value between 2 breakpoints in the middle part of the clamp function. It also adds a rem value to the vw unit to make sure the font-size still scales when the user sets a bigger font-size in their browser settings.
