...
{/* You can paint the baseline grid behind your content with two layered repeating gradients: a bolder line every full line, a fainter one on every baseline step. */}
...
import BaselineText from "../../components/Demos/Baseline/BaselineText.astro";
...
Have a look at a working example on the [demo page](/demos/baseline-grid) with the latest version of Chrome or Edge. Or checkout the [codepen](https://codepen.io/simoncoudeville/pen/rajaaQg).
