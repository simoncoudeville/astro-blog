...
description: "A look at how to implement fluid typography with no external dependencies. Only CSS variables, calc() and clamp()."
pubDate: 2025-09-15
draft: false
---
...
Have a look at a working example on the [demo page](/demos/fluid-modular-scale). Or checkout the [codepen](https://codepen.io/simoncoudeville/pen/QWxGvpR) if you want to see the full code. Be sure to change some of the parameters in the CSS.

## CSS functions

**Edit 1 Oct 2025** - Apparently we live in the future now and with the latest versions of Chrome and Edge, you can now use CSS functions. This means you can define a function that encapsulates the fluid typography calculation and use it directly in your CSS.
...
Have a look at a working example on the [demo page](/demos/fluid-type-function) with the latest version of Chrome or Edge. Or checkout the [codepen](https://codepen.io/simoncoudeville/pen/PwZGbyz) with the fluid scales applied to it.
